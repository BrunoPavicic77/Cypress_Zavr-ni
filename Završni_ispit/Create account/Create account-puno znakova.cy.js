...
var input = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";


describe("Tijekom registracije novog korisnika u ime unosi puno znamenki",()=>{
    ...
    it("Unosi podatke o korisniku i pod firstname poziva input funkciju koja se nalazi na vrhu",()=>{

        cy.url().should("contain","account-creation");
        cy.xpath("//input[@id='id_gender1']").click();
        cy.xpath("//input[@id='customer_firstname']").click().type(input);
        ...
        cy.xpath("//div[@class='alert alert-danger']").should("contain.text","firstname is too long. Maximum length: 32");

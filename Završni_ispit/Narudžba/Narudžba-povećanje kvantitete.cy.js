describe("Testira tipku + za povećanje količine proizvoda u košarici",()=>{
    ...
    it("Stavlja proizvod u košaricu te mu dodaje još jedan isti proizvod preko povećanja Qty",()=>{
        ...
        cy.xpath("//i[@class='icon-plus']").click()
